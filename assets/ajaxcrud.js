...
(function( $ ) {
    ...
    $.fn.ajaxCrud = function(){
        ...
        var toggleButtonCls='.btn-toggle';
        ...
        */
        ...
        function onToggleButtonAction(e){
            e.preventDefault();
            var toggleButton = this;
            if($(toggleButton).hasAttr("data-confirm-message")){
                if(!confirm($(this).attr("data-confirm-message"))){
                    return false;
                }
            }
        ...
        $(dataTableId).on("click",toggleButtonCls,onToggleButtonAction);


    }

$('#ajaxCrudDatatable').ajaxCrud();
